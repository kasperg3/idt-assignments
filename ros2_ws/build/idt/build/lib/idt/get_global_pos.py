...
class ros_node_class(Node):
    def __init__(self):
        ...
        # subscribers
        self.sub_global_pos = self.create_subscription(NavSatFix, '/mavros/global_position/global', self.on_global_pos_msg, QoSProfile(depth=10, reliability=ReliabilityPolicy.BEST_EFFORT))

        self.sub_global_pos_raw = self.create_subscription(NavSatFix, '/mavros/global_position/raw/fix', self.on_global_pos_raw_msg, QoSProfile(depth=10, reliability=ReliabilityPolicy.BEST_EFFORT))
